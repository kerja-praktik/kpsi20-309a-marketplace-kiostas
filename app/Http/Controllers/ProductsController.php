...
class ProductsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('product.create')->with('message','Produk Berhasil Ditambahkan!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('product.index')->with('message','Data Produk Berhasil Diupdate!');
    }
