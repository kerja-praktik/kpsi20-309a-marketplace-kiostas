...
@section('content')
    <div class="container">
        ...
        <p class="text-center">Silahkan melakukan pembayaran dengan menekan tombol pembayaran di bawah ini.</p>

        <div class="text-center">
            <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
            <input type="hidden" name="cmd" value="_xclick">
            <input type="hidden" name="business" value="KiosKitaSemua.kiostas@gmail.com">
