...
<body>
    ...
    <div class ="template">
        <div class="main">
        <img src="{{ asset('img/beli.png') }}"  style="display: block; margin: auto" width="450px" heigth="450px" >
         ...
         <h6>9. Barang rusak dalam pengiriman diluar tanggung jawab KIOSTAS sebagai penyedia platform.</h6>
