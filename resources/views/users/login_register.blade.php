            ...
            <div class="col-sm-4">
                <div class="signup-form"><!--sign up form-->
                    ...
                    <form action="{{url('/register_user')}}" method="post" class="form-horizontal">
                        ...
                        <input type="password" placeholder="Kata Sandi" name="password" value="{{old('password')}}"/>
                        <span class="text-danger">{{$errors->first('password')}}</span>

                        <input type="password" placeholder="Konfirmasi Kata Sandi" name="password_confirmation" value="{{old('password_confirmation')}}"/>
